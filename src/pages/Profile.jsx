...
const handleDelete =async ()=>{
  try {
    await confirm({
      ...
      title: 'Biztosan törölni akarod a fiókodat?'
    })
  ...
  return (
    <div className="createBlog">
      ...
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        {loading && <Loader />}
        {uploaded && <MyAlert text='Profile picture saved succesfully!' />}
      </Form>
      <div className="button btn btn-danger m-2"
      onClick={handleDelete}>Deleting the profile</div>
    </div>
  );
};
